...
| Composer 队列拖拽重排 | [#97](https://github.com/BubblePtr/pace/issues/97) | 已落地：clear + replay 按 Pace 消息 id 重放；等待区整卡拖拽。Steer-from-queue（[#327](https://github.com/BubblePtr/pace/issues/327)）在同一把锁里把 follow-up 提升为 steering，行显示 Steered |
